    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _context.abrupt("return", res.status(403).send('No token provided'));
        case 3:
          _context.prev = 3;
          decoded = _jsonwebtoken["default"].verify(token, 'secretKey'); // Giải mã JWT
          req.user = decoded;
          next();
          _context.next = 12;
          break;
...
var authorize = function authorize(roles) {
  return function (req, res, next) {
    var _req$user;
    var userRole = (_req$user = req.user) === null || _req$user === void 0 ? void 0 : _req$user.role;
