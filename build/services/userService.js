  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(password) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          return _context.abrupt("return", _bcrypt["default"].hash(password, saltRounds));
        case 3:
        case "end":
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(email, password) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          _context2.next = 8;
          return _bcrypt["default"].compare(password, user.UserPassword);
        case 8:
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _userModel["default"].find({}, '-UserPassword').lean();
        case 3:
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return _userModel["default"].findById(userId, '-UserPassword').lean();
        case 3:
          user = _context5.sent;
...
var createNewUser = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(data) {
    var Email, UserName, UserPassword, Phone, Role, existingUser, hashedPassword, newUser;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.prev = 0;
          Email = data.Email, UserName = data.UserName, UserPassword = data.UserPassword, Phone = data.Phone, Role = data.Role;
          _context6.next = 4;
          return _userModel["default"].findOne({
            Email: Email
          });
...
var updateUserData = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(data) {
    var UserId, UserName, Email, Phone, Role, user;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.prev = 0;
          UserId = data.UserId, UserName = data.UserName, Email = data.Email, Phone = data.Phone, Role = data.Role;
          if (UserId) {
            _context7.next = 4;
            break;
          }
...
var sendResetPasswordEmail = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(email) {
    var user, token, resetLink, testAccount, transporter, info;
      ...
      while (1) switch (_context9.prev = _context9.next) {
        ...
        case 3:
          ...
          return _context9.abrupt("return", {
            errCode: 1,
            errMessage: 'Email not found in the system!'
          });
        case 6:
          token = _jsonwebtoken["default"].sign({
            email: user.Email
        ...
        case 10:
          ...
          return transporter.sendMail({
            ...
            html: "<p>You requested a password reset. Click <a href=\"".concat(resetLink, "\">here</a> to proceed.</p>")
          });
        case 14:
          info = _context9.sent;
          console.log('Preview email at:', _nodemailer["default"].getTestMessageUrl(info));
          return _context9.abrupt("return", {
            errCode: 0,
        ...
        case 19:
          ...
          console.error('Error sending password reset email:', _context9.t0);
          return _context9.abrupt("return", {
            errCode: 2,
  ...
  return function sendResetPasswordEmail(_x9) {
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        ...
        case 15:
          ...
          console.error('Error resetting password:', _context10.t0);
          return _context10.abrupt("return", {
            errCode: 2,
            errMessage: 'System error!'
          });
